    ...
    BEGIN
      ...
      OPEN  cr_rtf ( v_data , p_nm_empresa, p_proc_id );
        ...
        LOOP
            ...
            FETCH cr_rtf
                BULK COLLECT INTO 
                 g_cod_empresa          , g_cod_estab       , g_data_fiscal     , g_movto_e_s
               , g_norm_dev             , g_ident_docto     , g_ident_fis_jur   , g_num_docfis
               , g_serie_docfis         , g_sub_serie_docfis, g_ident_servico   , g_num_item
               , g_periodo_emissao      , g_cgc             , g_num_docto       , g_tipo_docto
               , g_data_emissao         , g_cgc_fornecedor  , g_uf              , g_valor_total
               , g_vlr_base_inss        , g_vlr_inss        , g_codigo_fisjur   , g_razao_social
               , g_municipio_prestador  , g_cod_servico     , g_cod_cei         , g_equalizacao
                LIMIT cc_limit ;
            ...
            FORALL i IN g_cod_empresa.FIRST .. g_cod_empresa.LAST
             ...
             --INTO  msafi.fin4816_report_fiscal_gtt 
               INTO  msaf.fin4816_report_fiscal_gtt 
            ...
            VALUES
             (   g_cod_empresa( i )          , g_cod_estab ( i )      , g_data_fiscal ( i )    , g_movto_e_s ( i )
               , g_norm_dev( i )             , g_ident_docto ( i )    , g_ident_fis_jur( i )   , g_num_docfis( i )
               , g_serie_docfis ( i )        , g_sub_serie_docfis( i ), g_ident_servico ( i )  , g_num_item( i )
               , g_periodo_emissao( i )      , g_cgc( i )             , g_num_docto ( i )      , g_tipo_docto( i )
               , g_data_emissao( i )         , g_cgc_fornecedor( i )  , g_uf ( i )             , g_valor_total( i )
               , g_vlr_base_inss ( i )       , g_vlr_inss( i )        , g_codigo_fisjur( i )   , g_razao_social( i )
               , g_municipio_prestador ( i ) , g_cod_servico( i )     , g_cod_cei( i )         , g_equalizacao ( i ) );            
            ...
            g_cod_empresa.delete;            g_cod_estab.delete;            g_data_fiscal.delete;            g_movto_e_s.delete;
            g_norm_dev.delete;               g_ident_docto.delete;          g_ident_fis_jur.delete;          g_num_docfis.delete;
            g_serie_docfis.delete;           g_sub_serie_docfis.delete;     g_ident_servico.delete;          g_num_item.delete;
            g_periodo_emissao.delete;        g_cgc.delete;                  g_num_docto.delete;              g_tipo_docto.delete;
            g_data_emissao.delete;           g_cgc_fornecedor.delete;       g_uf.delete;                     g_valor_total.delete;
            g_vlr_base_inss.delete;          g_vlr_inss.delete;             g_codigo_fisjur.delete;          g_razao_social.delete;
            g_municipio_prestador.delete;    g_cod_servico.delete;           g_cod_cei.delete;               g_equalizacao.delete;
            --
            vn_count_new := vn_count_new + SQL%ROWCOUNT;
            --
            COMMIT;
                ...
                FORALL i IN g_num_item_prv.FIRST .. g_num_item_prv.LAST
                    INSERT /*+ APPEND */
                      --   INTO  msafi.dpsp_tb_fin4816_reinf_prev_gtt
                          INTO  msaf.dpsp_tb_fin4816_reinf_prev_gtt ( tipo
                                                                     , "Codigo Empresa"
                ...
                FORALL i IN g_cod_empresa2.FIRST .. g_cod_empresa2.LAST
                    INSERT /*+ APPEND */
                         --INTO  msafi.fin4816_reinf_2010_gtt
                          INTO  msaf.fin4816_reinf_2010_gtt ( cod_empresa
                                                             , cod_estab
                                                             , dat_emissao
                                                             , iden_fis_jur
                                                             , num_docfis
