...
IS
    ...
    TYPE typ_cod_empresa IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.cod_empresa%TYPE;

    TYPE typ_cod_estab IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.cod_estab%TYPE;

    TYPE typ_data_fiscal IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.data_fiscal%TYPE;

    TYPE typ_movto_e_s IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.movto_e_s%TYPE;

    TYPE typ_norm_dev IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.norm_dev%TYPE;

    TYPE typ_ident_docto IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.ident_docto%TYPE;

    TYPE typ_ident_fis_jur IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.ident_fis_jur%TYPE;

    TYPE typ_num_docfis IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.num_docfis%TYPE;

    TYPE typ_serie_docfis IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.serie_docfis%TYPE;

    TYPE typ_sub_serie_docfis IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.sub_serie_docfis%TYPE;

    TYPE typ_ident_servico IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.ident_servico%TYPE;

    TYPE typ_num_item IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.num_item%TYPE;

    TYPE typ_periodo_emissao IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.periodo_emissao%TYPE;

    TYPE typ_cgc IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.cgc%TYPE;

    TYPE typ_num_docto IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.num_docto%TYPE;

    TYPE typ_tipo_docto IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.tipo_docto%TYPE;

    TYPE typ_data_emissao IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.data_emissao%TYPE;

    TYPE typ_cgc_fornecedor IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.cgc_fornecedor%TYPE;

    TYPE typ_uf IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.uf%TYPE;

    TYPE typ_valor_total IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.valor_total%TYPE;

    TYPE typ_vlr_base_inss IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.vlr_base_inss%TYPE;

    TYPE typ_vlr_inss IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.vlr_inss%TYPE;

    TYPE typ_codigo_fisjur IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.codigo_fisjur%TYPE;

    TYPE typ_razao_social IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.razao_social%TYPE;

    TYPE typ_municipio_prestador IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.municipio_prestador%TYPE;

    TYPE typ_cod_servico IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.cod_servico%TYPE;

    TYPE typ_cod_cei IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.cod_cei%TYPE;

    TYPE typ_equalizacao IS TABLE OF MSAFI.TB_FIN4816_REPORT_FISCAL_GTT.equalizacao%TYPE;
    ...
    -- =======================================
    TYPE typ_tipo_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.tipo%TYPE;

    TYPE typ_codigo_empresa_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Codigo Empresa"%TYPE;

    TYPE typ_codigo_estab_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Codigo Estabelecimento"%TYPE;

    TYPE typ_data_emissao_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Data Emissão"%TYPE;

    TYPE typ_data_fiscal_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Data Fiscal"%TYPE;

    TYPE typ_ident_fis_jur_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.ident_fis_jur%TYPE;

    TYPE typ_ident_docto_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.ident_docto%TYPE;

    TYPE typ_numero_nota_fiscal_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Número da Nota Fiscal"%TYPE;

    TYPE typ_docto_serie_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Docto/Série"%TYPE;

    TYPE typ_emissao_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Emissão"%TYPE;

    TYPE typ_serie_docfis_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.serie_docfis%TYPE;

    TYPE typ_sub_serie_docfis_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.sub_serie_docfis%TYPE;

    TYPE typ_num_item_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.num_item%TYPE;

    TYPE typ_cod_usuario_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.cod_usuario%TYPE;

    TYPE typ_codigo_pess_fis_jur_prv
        IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Codigo Pessoa Fisica/Juridica"%TYPE;

    TYPE typ_razao_social_cliente_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Razão Social Cliente"%TYPE;

    TYPE typ_ind_fis_jur_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.ind_fis_jur%TYPE;

    TYPE typ_cnpj_cliente_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."CNPJ Cliente"%TYPE;

    TYPE typ_cod_class_doc_fis_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.cod_class_doc_fis%TYPE;

    TYPE typ_vlr_tot_nota_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.vlr_tot_nota%TYPE;

    TYPE typ_vlr_bs_calc_retencao_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Vlr Base Calc. Retenção"%TYPE;

    TYPE typ_vlr_aliq_inss_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.vlr_aliq_inss%TYPE;

    TYPE typ_vlr_trib_inss_retido_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Vlr.Trib INSS RETIDO"%TYPE;

    TYPE typ_vlr_retencao_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Valor da Retenção"%TYPE;

    TYPE typ_vlr_contab_compl_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.vlr_contab_compl%TYPE;

    TYPE typ_ind_tipo_proc_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.ind_tipo_proc%TYPE;

    TYPE typ_num_proc_jur_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.num_proc_jur%TYPE;

    TYPE typ_razao_social_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.razao_social%TYPE;

    TYPE typ_cgc_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.cgc%TYPE;

    TYPE typ_documento_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Documento"%TYPE;

    TYPE typ_tipo_serv_e_social_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Tipo de Serviço E-social"%TYPE;

    TYPE typ_dsc_tipo_serv_esocial_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.dsc_tipo_serv_esocial%TYPE;

    TYPE typ_razao_social_drogaria_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Razão Social Drogaria"%TYPE;

    TYPE typ_valor_servico_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Valor do Servico"%TYPE;

    TYPE typ_num_proc_adj_adic_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.num_proc_adj_adic%TYPE;

    TYPE typ_ind_tp_proc_adj_adic_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.ind_tp_proc_adj_adic%TYPE;

    TYPE typ_codigo_serv_prod_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.codigo_serv_prod%TYPE;

    TYPE typ_desc_serv_prod_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.desc_serv_prod%TYPE;

    TYPE typ_cod_docto_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.cod_docto%TYPE;

    TYPE typ_observação_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT."Observação"%TYPE;

    TYPE typ_dsc_param_prv IS TABLE OF MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT.dsc_param%TYPE;
    ...
    TYPE typ_cod_empresa2 IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.cod_empresa%TYPE;

    TYPE typ_cod_estab2 IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.cod_estab%TYPE;

    TYPE typ_dat_emissao2 IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.dat_emissao%TYPE;

    TYPE typ_iden_fis_jur2 IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.iden_fis_jur%TYPE;

    TYPE typ_num_docfis2 IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.num_docfis%TYPE;

    TYPE typ_cd_empresa IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT."Codigo Empresa"%TYPE;

    TYPE typ_rz_social_drogaria IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT."Razão Social Drogaria"%TYPE;

    TYPE typ_rz_social_client IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT."Razão Social Cliente"%TYPE;

    TYPE typ_ntf IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT."Número da Nota Fiscal"%TYPE;

    TYPE typ_data_emissao_nf IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT."Data de Emissão da NF"%TYPE;

    TYPE typ_data_fiscal2 IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT."Data Fiscal"%TYPE;

    TYPE typ_vlr_tributo IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT."Valor do Tributo"%TYPE;

    TYPE typ_observacao IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT."observacao"%TYPE;

    TYPE typ_tp_servico_e_social IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT."Tipo de Serviço E-social"%TYPE;

    TYPE typ_vlr_bs_calc_retencao IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT."Vlr. Base de Calc. Retenção"%TYPE;

    TYPE typ_vlr_retencao IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT."Valor da Retenção"%TYPE;

    TYPE typ_proc_id IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.proc_id%TYPE;

    TYPE typ_ind_status IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.ind_status%TYPE;

    TYPE typ_cnpj_prestador IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.cnpj_prestador%TYPE;

    TYPE typ_ind_obra IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.ind_obra%TYPE;

    TYPE typ_tp_inscricao IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.tp_inscricao%TYPE;

    TYPE typ_nr_inscricao IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.nr_inscricao%TYPE;

    TYPE typ_num_recibo IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.num_recibo%TYPE;

    TYPE typ_ind_tp_amb IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.ind_tp_amb%TYPE;

    TYPE typ_vlr_bruto IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.vlr_bruto%TYPE;

    TYPE typ_vlr_base_ret IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.vlr_base_ret%TYPE;

    TYPE typ_vlr_ret_princ IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.vlr_ret_princ%TYPE;

    TYPE typ_vlr_ret_adic IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.vlr_ret_adic%TYPE;

    TYPE typ_vlr_n_ret_princ IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.vlr_n_ret_princ%TYPE;

    TYPE typ_vlr_n_ret_adic IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.vlr_n_ret_adic%TYPE;

    TYPE typ_ind_cprb IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.ind_cprb%TYPE;

    TYPE typ_cod_versao_proc IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.cod_versao_proc%TYPE;

    TYPE typ_cod_versao_layout IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.cod_versao_layout%TYPE;

    TYPE typ_ind_proc_emissao IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.ind_proc_emissao%TYPE;

    TYPE typ_id_evento IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.id_evento%TYPE;

    TYPE typ_ind_oper IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.ind_oper%TYPE;

    TYPE typ_dat_ocorrencia IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.dat_ocorrencia%TYPE;

    TYPE typ_cgc_cpf IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.cgc%TYPE;

    TYPE typ_rz_social IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.razao_social%TYPE;

    TYPE typ_x04_razao_social IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.x04_razao_social%TYPE;

    TYPE typ_id_r2010_oc IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.id_r2010_oc%TYPE;

    TYPE typ_nm_docto IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.num_docto%TYPE;

    TYPE typ_serie IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.serie%TYPE;

    TYPE typ_dat_emissao_nf IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.dat_emissao_nf%TYPE;

    TYPE typ_dt_fiscal IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.data_fiscal%TYPE;

    TYPE typ_rnf_vlr_bruto IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.rnf_vlr_bruto%TYPE;

    TYPE typ_obs IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.observacao%TYPE;

    TYPE typ_id_r2010_nf IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.id_r2010_nf%TYPE;

    TYPE typ_ind_tp_proc_adj_adic IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.ind_tp_proc_adj_adic%TYPE;

    TYPE typ_num_proc_adj_adic IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.num_proc_adj_adic%TYPE;

    TYPE typ_cod_susp_adic IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.cod_susp_adic%TYPE;

    TYPE typ_radic_vlr_n_ret_adic IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.radic_vlr_n_ret_adic%TYPE;

    TYPE typ_ind_tp_proc_adj_princ IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.ind_tp_proc_adj_princ%TYPE;

    TYPE typ_num_proc_adj_princ IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.num_proc_adj_princ%TYPE;

    TYPE typ_cod_susp_princ IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.cod_susp_princ%TYPE;

    TYPE typ_rprinc_vlr_n_ret_princ IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.rprinc_vlr_n_ret_princ%TYPE;

    TYPE typ_tp_servico IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.tp_servico%TYPE;

    TYPE typ_rserv_vlr_base_ret IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.rserv_vlr_base_ret%TYPE;

    TYPE typ_valor_retencao IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.vlr_retencao%TYPE;

    TYPE typ_vlr_ret_sub IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.vlr_ret_sub%TYPE;

    TYPE typ_rserv_vlr_n_ret_princ IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.rserv_vlr_n_ret_princ%TYPE;

    TYPE typ_vlr_servicos_15 IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.vlr_servicos_15%TYPE;

    TYPE typ_vlr_servicos_20 IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.vlr_servicos_20%TYPE;

    TYPE typ_vlr_servicos_25 IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.vlr_servicos_25%TYPE;

    TYPE typ_rserv_vlr_ret_adic IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.rserv_vlr_ret_adic%TYPE;

    TYPE typ_rserv_vlr_n_ret_adic IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.rserv_vlr_n_ret_adic%TYPE;

    TYPE typ_rnk IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.rnk%TYPE;

    TYPE typ_id_pger_apur IS TABLE OF MSAFI.TB_FIN4816_REINF_2010_GTT.id_pger_apur%TYPE;
    ...
    IS
        SELECT   rpf.cod_empresa AS "Codigo da Empresa"
               ...
               , NVL ( ( SELECT 'S'
                           FROM MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT rprev
                          WHERE 1 = 1
...
--                                , p_proc_id         => p_proc_id );
        ...
        LOOP
            ...
            FORALL i IN g_cod_empresa.FIRST .. g_cod_empresa.LAST
                INSERT /*+ APPEND */
                      INTO  MSAFI.TB_FIN4816_REPORT_FISCAL_GTT ( cod_empresa
                                                            , cod_estab
                                                            , data_fiscal
                                                            , movto_e_s
                                                            , norm_dev
        ...
        BEGIN
            ...
            LOOP
                ...
                FORALL i IN g_num_item_prv.FIRST .. g_num_item_prv.LAST
                    INSERT /*+ APPEND */
                          INTO  MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT( tipo
                                                                     , "Codigo Empresa"
        ...
        BEGIN
            ...
            LOOP
                ...
                FORALL i IN g_cod_empresa2.FIRST .. g_cod_empresa2.LAST
                    INSERT /*+ APPEND */
                          INTO  MSAFI.TB_FIN4816_REINF_2010_GTT ( cod_empresa
                                                             , cod_estab
                                                             , dat_emissao
                                                             , iden_fis_jur
                                                             , num_docfis
    ...
    BEGIN
        ...
        BEGIN
            ...
            DELETE FROM MSAFI.TB_FIN4816_REPORT_FISCAL_GTT; -- 1. tb_fin4816_report_fiscal_01_gtt    ( através do item(1) faz se uma uma view inline no item 1,3,4
           ...
           -- DELETE FROM MSAFI.TB_DPSP_FIN4816_REINF_PREV_GTT. -- 3. tb_fin4816_stg_report_prev_03_gtt  ( executado uma query (union) junto com o resultado do item 2 )

           -- DELETE FROM MSAFI.TB_FIN4816_REINF_2010_GTT. -- 4. tb_fin4816_stg_report_reinf_04_gtt ( executa a query e salva nessa tabela)

            DELETE FROM MSAFI.TB_FIN4816_PREV_TMP_ESTAB; -- 5. tb_fin4816_stg_estab_05_gtt        ( salva todos os estabelecimentos  para executa os processos)
