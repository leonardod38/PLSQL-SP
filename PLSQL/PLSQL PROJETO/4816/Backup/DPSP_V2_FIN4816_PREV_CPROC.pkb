CREATE OR REPLACE PACKAGE BODY MSAF.dpsp_v2_fin4816_prev_cproc
IS
    mproc_id NUMBER;
    ...
    mnm_cproc VARCHAR2 ( 100 ) := '2.Relatorio de apoio';
    mds_cproc VARCHAR2 ( 100 ) := 'Validacao das Inf. Reinf V2';
    ...
    -- =======================================
    TYPE typ_tipo_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.tipo%TYPE;

    TYPE typ_codigo_empresa_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Codigo Empresa"%TYPE;

    TYPE typ_codigo_estab_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Codigo Estabelecimento"%TYPE;

    TYPE typ_data_emissao_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Data Emissão"%TYPE;

    TYPE typ_data_fiscal_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Data Fiscal"%TYPE;

    TYPE typ_ident_fis_jur_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.ident_fis_jur%TYPE;

    TYPE typ_ident_docto_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.ident_docto%TYPE;

    TYPE typ_numero_nota_fiscal_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Número da Nota Fiscal"%TYPE;

    TYPE typ_docto_serie_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Docto/Série"%TYPE;

    TYPE typ_emissao_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Emissão"%TYPE;

    TYPE typ_serie_docfis_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.serie_docfis%TYPE;

    TYPE typ_sub_serie_docfis_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.sub_serie_docfis%TYPE;

    TYPE typ_num_item_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.num_item%TYPE;

    TYPE typ_cod_usuario_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.cod_usuario%TYPE;

    TYPE typ_codigo_pess_fis_jur_prv
        IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Codigo Pessoa Fisica/Juridica"%TYPE;

    TYPE typ_razao_social_cliente_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Razão Social Cliente"%TYPE;

    TYPE typ_ind_fis_jur_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.ind_fis_jur%TYPE;

    TYPE typ_cnpj_cliente_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."CNPJ Cliente"%TYPE;

    TYPE typ_cod_class_doc_fis_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.cod_class_doc_fis%TYPE;

    TYPE typ_vlr_tot_nota_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.vlr_tot_nota%TYPE;

    TYPE typ_vlr_bs_calc_retencao_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Vlr Base Calc. Retenção"%TYPE;

    TYPE typ_vlr_aliq_inss_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.vlr_aliq_inss%TYPE;

    TYPE typ_vlr_trib_inss_retido_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Vlr.Trib INSS RETIDO"%TYPE;

    TYPE typ_vlr_retencao_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Valor da Retenção"%TYPE;

    TYPE typ_vlr_contab_compl_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.vlr_contab_compl%TYPE;

    TYPE typ_ind_tipo_proc_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.ind_tipo_proc%TYPE;

    TYPE typ_num_proc_jur_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.num_proc_jur%TYPE;

    TYPE typ_razao_social_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.razao_social%TYPE;

    TYPE typ_cgc_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.cgc%TYPE;

    TYPE typ_documento_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Documento"%TYPE;

    TYPE typ_tipo_serv_e_social_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Tipo de Serviço E-social"%TYPE;

    TYPE typ_dsc_tipo_serv_esocial_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.dsc_tipo_serv_esocial%TYPE;

    TYPE typ_razao_social_drogaria_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Razão Social Drogaria"%TYPE;

    TYPE typ_valor_servico_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Valor do Servico"%TYPE;

    TYPE typ_num_proc_adj_adic_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.num_proc_adj_adic%TYPE;

    TYPE typ_ind_tp_proc_adj_adic_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.ind_tp_proc_adj_adic%TYPE;

    TYPE typ_codigo_serv_prod_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.codigo_serv_prod%TYPE;

    TYPE typ_desc_serv_prod_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.desc_serv_prod%TYPE;

    TYPE typ_cod_docto_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.cod_docto%TYPE;

    TYPE typ_observação_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT."Observação"%TYPE;

    TYPE typ_dsc_param_prv IS TABLE OF MSAFI.TB_FIN4816_REINF_PREV_GTT.dsc_param%TYPE;
       ...
       -- BEGIN
            ...
            LOOP
                ...
                FORALL i IN g_num_item_prv.FIRST .. g_num_item_prv.LAST
                    INSERT /*+ APPEND */
                          INTO  MSAFI.TB_FIN4816_REINF_PREV_GTT( tipo
                                                                     , "Codigo Empresa"
    ...
    BEGIN
        ...
        RETURN mproc_id;
    END;
END dpsp_v2_fin4816_prev_cproc;
/