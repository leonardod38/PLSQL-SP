CREATE OR REPLACE PACKAGE BODY MSAF.DPSP_V6_FIN4816_PREV_CPROC
IS
    mproc_id NUMBER;
    ...
    mnm_cproc VARCHAR2 ( 100 ) := '6.Relatorio de apoio';
    mds_cproc VARCHAR2 ( 100 ) := 'Validacao das Inf. Reinf (V6) - Two Sheet';
    ...
    BEGIN
        ...
        EXECUTE IMMEDIATE 'ALTER SESSION SET NLS_NUMERIC_CHARACTERS= '',.'' ';
         ...
         --============================================
                  ...
                  begin
                  DPSP_V6_FIN4816_PREV_CPROC.clear_workbook;
                  DPSP_V6_FIN4816_PREV_CPROC.new_sheet;
                  for c in 1 .. 10
                  loop
                  DPSP_V6_FIN4816_PREV_CPROC.cell( c, 1, 'COL' || c );
                  DPSP_V6_FIN4816_PREV_CPROC.cell( c, 2, 'val' || c );
                  DPSP_V6_FIN4816_PREV_CPROC.cell( c, 3, c );
                  end loop;
                  
                  DPSP_V6_FIN4816_PREV_CPROC.freeze_rows( 1 );
                  DPSP_V6_FIN4816_PREV_CPROC.new_sheet;
                  -- as_xlsx.save( 'MSAFIMP', 'my13.xlsx' );
                  end;
