Prompt Package Body DPSP_FIN42_REL_INCINE_V2_CPROC;
--
-- DPSP_FIN42_REL_INCINE_V2_CPROC  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY dpsp_fin42_rel_incine_v2_cproc
IS
    FUNCTION parametros
        RETURN VARCHAR2
    IS
    ...
    BEGIN
        ...
        mproc_id :=
            lib_proc.new ( 'DPSP_FIN42_REL_INCINE_V2_CPROC'
                         , 48
                         , 150 );
...
END dpsp_fin42_rel_incine_v2_cproc;
/
SHOW ERRORS;
