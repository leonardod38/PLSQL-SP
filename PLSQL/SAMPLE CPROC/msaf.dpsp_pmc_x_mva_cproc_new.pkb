Prompt Package Body DPSP_PMC_X_MVA_CPROC_NEW;
--
-- DPSP_PMC_X_MVA_CPROC_NEW  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY dpsp_pmc_x_mva_cproc_new
IS
    mproc_id INTEGER;
    mproc_id_o INTEGER;
