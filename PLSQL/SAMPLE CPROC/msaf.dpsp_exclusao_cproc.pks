Prompt Package DPSP_EXCLUSAO_CPROC;
--
-- DPSP_EXCLUSAO_CPROC  (Package) 
--
CREATE OR REPLACE PACKAGE dpsp_exclusao_cproc
IS
    -- AUTOR    : DSP - RODOLFO
    -- DATA     : CRIADA EM 29/NOV/2017
    -- DESCRIÇÃO: Projeto 930
    -- V8 CRIADA EM 18/07/2018: REBELLO - MELHORIA DE PERFORMANCE
