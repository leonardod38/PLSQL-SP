Prompt Package Body DPSP_EXCL_REL_COMPRAS_CPROC;
--
-- DPSP_EXCL_REL_COMPRAS_CPROC  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY dpsp_excl_rel_compras_cproc
IS
    ...
    BEGIN
        v_proc_id := lib_proc.new ( 'DPSP_EXCL_REL_COMPRAS_CPROC' );
