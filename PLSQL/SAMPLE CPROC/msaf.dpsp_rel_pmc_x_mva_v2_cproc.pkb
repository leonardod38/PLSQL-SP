Prompt Package Body DPSP_REL_PMC_X_MVA_V2_CPROC;
--
-- DPSP_REL_PMC_X_MVA_V2_CPROC  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY dpsp_rel_pmc_x_mva_v2_cproc
IS
    FUNCTION parametros
        RETURN VARCHAR2
    IS
    ...
    IS
    BEGIN
        RETURN 'Relatório de PMC x MVA (V2)';
    END;
    ...
    IS
    BEGIN
        RETURN 'Relatório de Ressarcimento PMC x MVA - Sintético e Analítico';
    END;
    ...
    BEGIN
        ...
        mcod_empresa := lib_parametros.recuperar ( 'EMPRESA' );
        mproc_id :=
            lib_proc.new ( 'DPSP_REL_PMC_X_MVA_V2_CPROC'
                         , 48
                         , 150 );
        ...
        IF ( p_conf = 'S' ) THEN --(1)
            ...
            FOR i IN 1 .. a_estabs.COUNT --(5)
                ...
                v_text01 := v_text01 || '  FROM MSAFI.DPSP_MSAF_PMC_MVA_V2 A, MSAFI.DSP_ESTABELECIMENTO B ';
                v_text01 :=
                       v_text01
        ...
        IF ( p_analitico = 'S' ) THEN
            ...
            FOR i IN 1 .. a_estabs.COUNT LOOP
                ...
                FOR cr_r IN load_analitico ( a_estabs ( i )
                    ...
                    AND cr_r.vlr_dif_qtde < 0 ) THEN --(1)
                        IF v_class = 'a' THEN
                            v_class := 'b';
                        ELSE
                            v_class := 'a';
