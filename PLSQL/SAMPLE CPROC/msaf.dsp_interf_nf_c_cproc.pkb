Prompt Package Body DSP_INTERF_NF_C_CPROC;
--
-- DSP_INTERF_NF_C_CPROC  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY dsp_interf_nf_c_cproc
IS
    ...
    IS
    BEGIN
        RETURN 'Executar interfaces de Documentos Fiscais de CELULA';
    END;
    ...
    IS
    BEGIN
        RETURN 'Execução de interfaces Doc Fiscal de CELULA';
    END;
    ...
    BEGIN
        mproc_id :=
            lib_proc.new ( 'DSP_INTERF_NF_C_CPROC'
                         , 48
                         , 150 );
        lib_proc.add_tipo ( mproc_id
                          ...
                          , 'Processo'
                          , 1 );
        lib_proc.add_header ( 'Execução de interfaces de NF de CELULA'
                            , 1
                            , 1 );
        lib_proc.add ( ' ' );
        ...
        msafi.dsp_control.createprocess ( 'DSP_INTFC_NFS_C' --P_I_PROCID            IN VARCHAR2             , --VARCHAR2(16)
                                        , 'EXEC INTFC NFS CELULA' --P_I_PROC_DESCR        IN VARCHAR2             , --VARCHAR2(64)
        ...
        v_txt_entrada := v_txt_entrada || ',P_CARREGA_CELULA=>''S''';
        ...
        IF ( p_cria_job = 'S' ) THEN
            ...
            INSERT INTO det_job_import ( num_job
                ...
                SELECT v_job_num --NUM_JOB
                     ...
                     , CASE WHEN a.grupo_arquivo = 1 THEN v_estab_grupo END --COD_ESTAB
                     , CASE
