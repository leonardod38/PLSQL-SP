Prompt Package DPSP_REL_PERDAS_CD_CPROC;
--
-- DPSP_REL_PERDAS_CD_CPROC  (Package) 
--
CREATE OR REPLACE PACKAGE dpsp_rel_perdas_cd_cproc
IS
    -- AUTOR    : ACCENTURE - GUILHERME SILVA
    -- DATA     : NOVA VERSAO CRIADA EM 30/JAN/2019
    -- DESCRIÇÃO: NOVO PROCESSAMENTO PARA RELATORIO DE PERDAS - FIN628
    ...
    IS
        SELECT   b.cod_empresa
            ...
            FROM (SELECT   cod_empresa
                      ...
                      FROM msafi.dpsp_msaf_perdas_cd
